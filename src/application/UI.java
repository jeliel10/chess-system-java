...
public class UI {
    ...
    public static ChessPosition readChessPosition(Scanner sc){
        try{
            String s = sc.nextLine(); // aqui eu irei inserir tudo junto, ex: a1 ou b2 ou c4...
            char column = s.charAt(0); // pega a letra, o primeiro caractere desse String
            int row = Integer.parseInt(s.substring(1)); // pega o numero, segundo caractere desse String
